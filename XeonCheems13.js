...
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@FraszHost
...
case 'sound160':
case 'sound161':
XeonBotInc_dev = await getBuffer(`https://github.com/Fraszzzz/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
...
if (!args[0]) return replygcxeon(`Where is the link?\nExample :\n${prefix}${command} https://github.com/Fraszzzz/XeonMedia`)
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"YouTube 🌹\",\"url\":\"https://youtube.com/@FraszHost\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"Telegram 💧\",\"url\":\"https://t.me/frasz0999\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"GitHub 🔘\",\"url\":\"https://github.com/Fraszzzz\",\"merchant_url\":\"https://www.google.com\"}"
              },
              {
                 "name": "cta_url",
